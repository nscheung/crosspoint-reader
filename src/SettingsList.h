...
inline std::vector<SettingInfo> getSettingsList() {
  return {
      ...
      SettingInfo::Toggle(StrId::STR_EMBEDDED_STYLE, &CrossPointSettings::embeddedStyle, "embeddedStyle",
                          StrId::STR_CAT_READER),
      SettingInfo::Enum(StrId::STR_PAGE_TURN_TIMER, &CrossPointSettings::pageTurnTimer,
                        {StrId::STR_PAGE_TURN_TIMER_OFF, StrId::STR_PAGE_TURN_TIMER_5S,
                         StrId::STR_PAGE_TURN_TIMER_15S, StrId::STR_PAGE_TURN_TIMER_30S,
                         StrId::STR_PAGE_TURN_TIMER_1MIN},
                        "pageTurnTimer", StrId::STR_CAT_READER),
